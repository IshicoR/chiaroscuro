...
use chiaro_live_telemetry as telemetry;
...
use chiaro_tray as tray;
use chiaro_window::{self as window, WindowMessage, WindowState};
use chiaroscuro_telemetry::{LoadedIbt, Session};
use iced::{
    Element,
    Length::Fill,
...
impl Chiaroscuro {
    ...
    fn view(&self) -> Element<'_, AppMessage> {
        ...
        let layout = column![
            ...
            iced::widget::row![navigation, content].height(Fill),
        ]
        .width(Fill)
        .height(Fill);
