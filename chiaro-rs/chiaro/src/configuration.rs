...
pub const DEFAULT_SERVER_ADDR: &str = "127.0.0.1:35565";
...
impl DesktopConfig {
    pub fn load() -> Result<Self, ConfigError> {
        ...
        let mut builder = Config::builder()
            ...
            .set_default("dark_theme", defaults.dark_theme)?
...
mod tests {
    ...
    use super::{DEFAULT_SERVER_ADDR, DesktopConfig, settings_path_from};

    #[test]
    fn defaults_to_the_local_relay() {
        assert_eq!(DesktopConfig::default().server_addr, DEFAULT_SERVER_ADDR);
    }
